...
class GazeLoss(nn.Module):
    def __init__(self,
        ...
        checkpoints_paths_dict = {'vgg16':'/fsx/nikitadrobyshev/latent-texture-avatar/losses/gaze_models/vgg_16_2_forward_sum.pt', 'resnet18':'/fsx/nikitadrobyshev/latent-texture-avatar/losses/gaze_models/resnet_18_2_forward_sum.pt'}
        if interpolate:
            checkpoints_paths_dict = {'vgg16':'/fsx/nikitadrobyshev/latent-texture-avatar/losses/gaze_models/vgg_16_2_forward_sum_inter.pt', 'resnet18':'/fsx/nikitadrobyshev/latent-texture-avatar/losses/gaze_models/resnet_18_2_forward_sum_inter.pt'}  
