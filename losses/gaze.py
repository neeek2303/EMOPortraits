...
class GazeLoss(nn.Module):
    def __init__(self,
                 ...
                 project_dir: str = '/fsx/nikitadrobyshev/latent-texture-avatar',
                 ) -> None:
        super(GazeLoss, self).__init__()
        self.len_features = len(layer_indices)
        checkpoints_paths_dict = {'vgg16':f'{project_dir}/losses/gaze_models/vgg_16_2_forward_sum.pt', 'resnet18':f'{project_dir}/losses/gaze_models/resnet_18_2_forward_sum.pt'}
        if interpolate:
            checkpoints_paths_dict = {'vgg16':f'{project_dir}/losses/gaze_models/vgg_16_2_forward_sum_inter.pt', 'resnet18':f'{project_dir}/losses/gaze_models/resnet_18_2_forward_sum_inter.pt'}  
