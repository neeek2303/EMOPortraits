...
# lmdb_name_dict ={
#             'RANDOM':['random_C','random_L','random_R'],
#             'TON_EM':['tongue_em_C','tongue_em_L','tongue_em_R', 'tongue_C','tongue_L','tongue_R'],
#             'FF_NR':['FF_NR_C','FF_NR_L','FF_NR_R'],
#             'FF':['FF_C','FF_L','FF_R'],
#             'BLINK':['blinks_C','blinks_L','blinks_R'],
#             'MAU_S':['MAU_strong_C','MAU_strong_L','MAU_strong_R'],
#             'MAU_M':['MAU_mild_C', 'MAU_mild_L','MAU_mild_R'],
#             'ROT':['rotations_C','rotations_L','rotations_R'],
#             'EYES':['eyes_C','eyes_L','eyes_R'],
#             'TON_ROT':['tongue_rot_C','tongue_rot_L','tongue_rot_R'],
#         }
# div_ratio = 3
...
# dict_of_vid_names = {
#             'random':['random_C','random_L','random_R'],
#             'tongue_em':['tongue_em_C','tongue_em_L','tongue_em_R'],
#             'tongue':['tongue_C','tongue_L','tongue_R'],
#             'FF_NR':['FF_NR_C','FF_NR_L','FF_NR_R'],
#             'FF':['FF_C','FF_L','FF_R'],
#             'blinks':['blinks_C','blinks_L','blinks_R'],
#             'MAU_strong':['MAU_strong_C','MAU_strong_L','MAU_strong_R'],
#             'MAU_mild':['MAU_mild_C', 'MAU_mild_L','MAU_mild_R'],
#             'rotations':['rotations_C','rotations_L','rotations_R'],
#             'eyes':['eyes_C','eyes_L','eyes_R'],
#             'tongue_rot':['tongue_rot_C','tongue_rot_L','tongue_rot_R'],
# }


dict_of_vid_names = {
            'random':['random_C','random_L','random_R'],
            'tongue_em':['tongue_em_C', 'tongue_C'],
            'tongue':['tongue_C',],
            'FF_NR':['FF_NR_C','FF_NR_L','FF_NR_R'],
            'FF':['FF_C',],
            'blinks':['blinks_C',],
...
list_of_lmdbs = [
            'ID_1/RANDOM', 'ID_1/BLINK', 'ID_1/TON_EM', 'ID_1/FF_NR',  'ID_1/FF', ...
...
class DataModule(object):
    ...
    def add_argparse_args(parent_parser: ArgumentParser, *, use_argument_group=True):
        ...
        parser.add_argument('--data_root', default='/fsx/FEED_dataset', type=str)
    ...
    def __init__(self, args):
        ...
        self.data_root = '/fsx/behavioural_computing_data/face_generation_data/FF_dataset'
            ...
            for phase, keys_phase in keys_i.items():
                if (not (L_n in list_of_lmdbs_only_test) and phase=='train'):
                    for vid_name in keys_i[phase].keys():
                        ...
                        if vid_name in dict_of_vid_names[vid_name[:-2]]:
                            keys_vid_list = []
