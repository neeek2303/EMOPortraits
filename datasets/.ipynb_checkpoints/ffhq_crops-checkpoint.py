...
class FFHQ_Crops_Dataset(data.Dataset):
    def __init__(self,
        ...
        # self.img_pathes = sorted(glob(images_root + '/*'))
        # self.masks_pathes = sorted(glob(masks_root + '/*'))
        # self.kp_pathes = sorted(glob(kp_root + '/*'))
    ...
    def __getitem__(self, index):
        ...
        file = self.filtered_indexes_pathes[index]
